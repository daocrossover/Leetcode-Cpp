...
// Binary Search
// Since tests are generated such that the answer will not exceed 10^7
// we set left = 1, max = 10^7 and use the binary search to check whether the candiate can meet the requirement
